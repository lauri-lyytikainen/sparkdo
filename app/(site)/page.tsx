      ...
      <div className="flex-col w-full">
        <div className=" flex flex-col text-center items-center my-40 gap-8">
          <h1 className="text-4xl font-bold">
            Your Tasks, <span className="text-primary">Sparked to Life</span>
          </h1>
        ...
        <div className="bg-primary rounded-2xl min-h-160"></div>
      </div>
      <div className="flex flex-col sm:flex-row my-8 gap-4">
        <div className="flex-1 flex flex-col justify-center gap-8">
          <h2 className="text-2xl font-bold">
            Organize Everything, Effortlessly
          </h2>
          <p className="text-lg max-w-xl">
            From work projects to personal errands, Sparkdo makes it simple to
            capture, organize, and prioritize every task. Get your thoughts out
